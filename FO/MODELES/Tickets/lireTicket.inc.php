<?php
	...
	{		
		...
		$sReq = "SELECT DISTINCT INT_CODE, INC_LIBELLE, LIB_LIBELLE, INT_LIBELLE, INT_DESCRIPTION, INT_HEUREDEB, INT_HEUREFIN, INT_DATEINTER, ETA_LIBELLE, INC_DEMANDE, INT_TECHNICIEN
